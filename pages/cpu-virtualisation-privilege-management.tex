...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{images/protection-rings-diagram.png}
    \caption{CPU protection rings \cite{implementation-of-internetworking-with-host-internet-in-oracle-virtualbox-guest-virtual-machines.pdf}.}
    \label{fig:cpu-protection-rings}
\end{figure}
